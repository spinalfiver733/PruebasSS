...
<div class="table-responsive">  
                            ...
                            <?php 
                              if ($row['estado'] == 'sin asignar'){
                                  ...
                                  <td style="background-color:red;border-radius:50%;">  
                                      <a href="asignar_ticket_cti.php?id=<?php echo $row['id'] ;?>" style="color:white;text-align:center;">SIN ASIGNAR</a></td>
                                    <?php
                              }
       ...
       <!--usuarios conectados-->              
        ...
        <h2 STYLE="COLOR:WHITE;"><STRONG>USUARIOS CONECTADOS : CTI </STRONG></h2>
            <?php  
