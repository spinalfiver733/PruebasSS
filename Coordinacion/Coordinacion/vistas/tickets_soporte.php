                 ...
                 <div class="main-box-body clearfix" >
                    <div class="col-sm-8">
                        <div class="small-box bg-aqua">
                            ...
                            <div class="inner">
                                <br>
                                 <h1 style="text-align:center;font-family:impact;color:#9F2241;background-color:white;border-radius:20px;">Tickets generados para la JUD de Soporte Técnico</h1>      
                                
                                
       <!--usuarios conectados-->              
            <?php  
                    $sql_fetch_todos = "SELECT * FROM tickets WHERE TIPO = 'SOPORTE' GROUP BY id DESC";
...
<div class="table-responsive">  
            ...
            <tbody>
                ...
                while ($row = mysqli_fetch_array($query)) { ?>
                    <tr>
                        ...
                        <td style="color:black;"><strong><?php echo $row['observaciones'] ?></strong></td>                        
                            ...
                            <?php 
                              if ($row['estado'] == 'sin asignar'){
                                  ...
                                  <td style="background-color:red;border-radius:50%;">  
                                      <a href="asignar_ticket_soporte.php?id=<?php echo $row['id'] ;?>" style="color:white;text-align:center;">SIN ASIGNAR</a></td>
                                    <?php
                              }
                    ...
                    <td style="color:black;">
                        <a href="imprimir.php?id=<?php echo $row['id'];?>"><button style="width:100%;height:50px;"><li class="fa fa-print"> IMRPIMIR TICKET</li></button>
                        </a>
       ...
       <!--usuarios conectados-->              
        ...
        <h2 STYLE="COLOR:WHITE;"><STRONG>USUARIOS CONECTADOS : SOPORTE</STRONG></h2>
            <?php  
                    $sql_fetch_todos = "SELECT * FROM usuarios where conectado = 1 AND direccion = 'tecnico_soporte'";
                    $query = mysqli_query($conexion, $sql_fetch_todos);
            ?>
        <table border ="1" class="table - table-striped">
            <tbody>
