...
switch ($_GET["op"]){
	...
	case 'guardaryeditar':
		...
		if (empty($idusuario)){
			$rspta=$usuarios->insertar($nombre,$direccion,$telefono,$login,$clave,$imagen,$_POST['permiso']);
			echo $rspta ? "Usuario registrado" : "Usuario no se pudo registrar";
		}
		else {
			$rspta=$usuarios->editar($idusuario,$nombre,$direccion,$telefono,$login,$clave,$imagen,$_POST['permiso']);
...
case 'listar':
	...
	break;
		...
		if (isset($fetch))
	    {
			...
			in_array(1,$valores)?$_SESSION['cti']=1:$_SESSION['cti']=0;
			in_array(2,$valores)?$_SESSION['soporte']=1:$_SESSION['soporte']=0;
			in_array(3,$valores)?$_SESSION['sistemas']=1:$_SESSION['sistemas']=0;            
			in_array(4,$valores)?$_SESSION['usuarios']=1:$_SESSION['usuarios']=0;		            
            in_array(5,$valores)?$_SESSION['tickets']=1:$_SESSION['tickets']=0;		
			in_array(6,$valores)?$_SESSION['escritorio']=1:$_SESSION['escritorio']=0;	
			in_array(7,$valores)?$_SESSION['mesa']=1:$_SESSION['mesa']=0;	
			in_array(8,$valores)?$_SESSION['t_sistemas']=1:$_SESSION['t_sistemas']=0;	
			in_array(9,$valores)?$_SESSION['t_soporte']=1:$_SESSION['t_soporte']=0;	
			in_array(10,$valores)?$_SESSION['t_cti']=1:$_SESSION['t_cti']=0;	
