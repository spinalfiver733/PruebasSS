                        ...
                        <div class="col-sm-12">
                            <div class="small-box bg-aqua">
                                <div class="inner">
                                    ...
                                    <!--usuarios tabla-->
                                    <?php
                                    $sql_fetch_todos = "SELECT * FROM tickets WHERE TIPO = 'SISTEMAS' AND id = '$id_ticket'";
                                        ...
                                        <form action="update_ticket_sistemas.php" method="POST" enctype="multipart/form-data">
                                            <div style="text-align:center;">
                                                <td style="float:center;">
                                                    <h1 style="color:#9F2241;"><strong> Asignar ticket al técnico: </strong></h1>
                                                </td>
                                                <td style="float:left;">
                                                    <select type="text" name="tecnico">
                                                        <?php
                                                        $sql_fetch_todos_problemas = "SELECT * FROM usuarios where conectado = 1 AND direccion = 'tecnico_sistemas'";
                                                        $query_problemas = mysqli_query($conexion, $sql_fetch_todos_problemas);
                                                        foreach ($query_problemas as $opciones_problemas):
                                                        ?>
                                                            <option value="<?php echo $opciones_problemas['nombre'] ?>" style="color:green;">
                                                                <h1><?php echo $opciones_problemas['nombre'] ?></h1>
                                                            </option>
                                                ...
                                                <br><br>
                                                <button type="submit" style="width: 50%;height: 100px;"><strong>
                                                        <h1 style="color:white;"> ASIGNAR TICKET <li class="fa fa-arrow-right"></li>
                                                        </h1>
                                                    </strong></button>
                                            </div>
                                        </form>
