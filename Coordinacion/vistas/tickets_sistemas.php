				...
				<div class="col-12">
					<div class="main-card">
						<div class="card-header">
							<h1 class="main-title">Tickets generados para la JUD de Desarrollo de Sistemas</h1>
						</div>

						<!--Tabla de tickets-->
						<?php
						$sql_fetch_todos = "SELECT * FROM tickets WHERE TIPO = 'SISTEMAS' ORDER BY id DESC";
										...
										<tr>
											...
											<td>
												<?php if ($row['estado'] == 'sin asignar') { ?>
													<a href="asignar_ticket_sistemas.php?id=<?php echo $row['id']; ?>" class="<?php echo $estado_class; ?>"><?php echo $estado_texto; ?></a>
												<?php } else { ?>
